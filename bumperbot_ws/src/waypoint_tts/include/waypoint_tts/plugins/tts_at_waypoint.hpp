...
#ifndef NAV2_WAYPOINT_FOLLOWER__PLUGINS__TTS_AT_WAYPOINT_HPP_
#define NAV2_WAYPOINT_FOLLOWER__PLUGINS__TTS_AT_WAYPOINT_HPP_
#pragma once
 ...
 *
 */
class TtsAtWaypoint : public nav2_core::WaypointTaskExecutor
{
public:
/**
 * @brief Construct a new TTS At Waypoint Arrival object
 *
 */
  TtsAtWaypoint();

  /**
   * @brief Destroy the TTS At Waypoint Arrival object
   *
   */
  ~TtsAtWaypoint();
...
#endif  // NAV2_WAYPOINT_FOLLOWER__PLUGINS__TTS_AT_WAYPOINT_HPP_